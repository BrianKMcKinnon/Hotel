 ...
 * @author Chandler
 */
public class GuestEnterlReservation extends javax.swing.JFrame {

    /**
     * Creates new form GuestCancelReservation
     */
    public GuestEnterlReservation() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuestEnterlReservation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuestEnterlReservation().setVisible(true);
            }
        });
    }
